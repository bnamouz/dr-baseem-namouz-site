(function () {
  ...
  if(!document.body.dataset.page){const fresh=new URL(location.href);if(fresh.searchParams.get('site-version')!=='20260907-unified-1'){fresh.searchParams.set('site-version','20260907-unified-1');location.replace(fresh.href);}return;}
