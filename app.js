(function () {
  ...
  if(!document.body.dataset.page){const fresh=new URL(location.href);if(fresh.searchParams.get('site-version')!=='20260912-private-care-1'){fresh.searchParams.set('site-version','20260912-private-care-1');location.replace(fresh.href);}return;}
