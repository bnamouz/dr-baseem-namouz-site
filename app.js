(function () {
  ...
  if(!document.body.dataset.page){const fresh=new URL(location.href);if(fresh.searchParams.get('site-version')!=='20260907-clinics-2'){fresh.searchParams.set('site-version','20260907-clinics-2');location.replace(fresh.href);}return;}
  ...
  function languageLinks(){document.querySelectorAll('a[href]').forEach(a=>{const u=new URL(a.getAttribute('href'),location.href);if((u.origin===location.origin&&/\.html$/.test(u.pathname))||u.origin==='https://magic-kids-hub.baseem-n.chatgpt.site'||(u.origin==='https://app.magickidsinstitute.com'&&u.pathname.startsWith('/book/'))){u.searchParams.set('lang',language);a.href=u.origin===location.origin?u.pathname+u.search+u.hash:u.href;}});}
